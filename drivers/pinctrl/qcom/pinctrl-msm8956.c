...
static const struct pinctrl_pin_desc msm8956_pins[] = {
...
static const struct msm_function msm8956_functions[] = {
	FUNCTION(gpio),
	FUNCTION(blsp_spi1),
	FUNCTION(smb_int),
	FUNCTION(adsp_ext),
...
static const struct msm_pingroup msm8956_groups[] = {
	...
	PINGROUP(75, wcss_bt, sdc3, NA, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(76, wcss_wlan, sdc3, NA, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(77, wcss_wlan, sdc3, NA, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(78, wcss_wlan, sdc3, NA, qdss_tracedata_a, NA, NA, NA, NA, NA),
	PINGROUP(79, wcss_wlan, sdc3, NA, NA, qdss_tracedata_a, NA, NA, NA, NA),
	PINGROUP(80, wcss_wlan, sdc3, NA, NA, NA, NA, NA, NA, NA),
...
static const struct msm_pinctrl_soc_data msm8956_pinctrl = {
	.pins = msm8956_pins,
	.npins = ARRAY_SIZE(msm8956_pins),
	.functions = msm8956_functions,
	.nfunctions = ARRAY_SIZE(msm8956_functions),
	.groups = msm8956_groups,
	.ngroups = ARRAY_SIZE(msm8956_groups),
	.ngpios = 145,
};

static int msm8956_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &msm8956_pinctrl);
}

static const struct of_device_id msm8956_pinctrl_of_match[] = {
	{ .compatible = "qcom,msm8956-pinctrl", },
	{ },
};

static struct platform_driver msm8956_pinctrl_driver = {
	.driver = {
		.name = "msm8956-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = msm8956_pinctrl_of_match,
	},
	.probe = msm8956_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init msm8956_pinctrl_init(void)
{
	return platform_driver_register(&msm8956_pinctrl_driver);
}
arch_initcall(msm8956_pinctrl_init);

static void __exit msm8956_pinctrl_exit(void)
{
	platform_driver_unregister(&msm8956_pinctrl_driver);
}
module_exit(msm8956_pinctrl_exit);

MODULE_DESCRIPTION("QTI msm8956 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, msm8956_pinctrl_of_match);
